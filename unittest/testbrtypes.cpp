...
static void BURGER_API ShowCompilerMacros(uint_t uVerbose)
{
    if (uVerbose & VERBOSE_MACROS) {
...
#if defined(__STDC__)
        Message(
            "__STDC__ is defined as \"" BURGER_STRINGIZE(__STDC__) "\"");
#else
        ...
        Message("__cplusplus is defined as \"" BURGER_STRINGIZE(
            __cplusplus) "\"");
#else
...
#if defined(__unix__)
        Message(
            "__unix__ is defined as \"" BURGER_STRINGIZE(__unix__) "\"");
#else
        ...
        Message("_XOPEN_UNIX is defined as \"" BURGER_STRINGIZE(
            _XOPEN_UNIX) "\"");
#else
        ...
        Message("__ILP32__ is defined as \"" BURGER_STRINGIZE(
            __ILP32__) "\"");
#else
...
#if defined(__LP64__)
        Message(
            "__LP64__ is defined as \"" BURGER_STRINGIZE(__LP64__) "\"");
#else
        ...
        Message("__TOS_AIX__ is defined as \"" BURGER_STRINGIZE(
            __TOS_AIX__) "\"");
#else
        ...
        Message("__ANDROID__ is defined as \"" BURGER_STRINGIZE(
            __ANDROID__) "\"");
#else
        ...
        Message("__amigaos__ is defined as \"" BURGER_STRINGIZE(
            __amigaos__) "\"");
#else
...
#if defined(__BEOS__)
        Message(
            "__BEOS__ is defined as \"" BURGER_STRINGIZE(__BEOS__) "\"");
#else
...
#if defined(__be_os)
        Message(
            "__be_os is defined as \"" BURGER_STRINGIZE(__be_os) "\"");
#else
...
#if defined(__bsdi__)
        Message(
            "__bsdi__ is defined as \"" BURGER_STRINGIZE(__bsdi__) "\"");
#else
        ...
        Message("__FreeBSD__ is defined as \"" BURGER_STRINGIZE(
            __FreeBSD__) "\"");
#else
        ...
        Message("__NetBSD__ is defined as \"" BURGER_STRINGIZE(
            __NetBSD__) "\"");
#else
        ...
        Message("__OpenBSD__ is defined as \"" BURGER_STRINGIZE(
            __OpenBSD__) "\"");
#else
        ...
        Message("__CYGWIN__ is defined as \"" BURGER_STRINGIZE(
            __CYGWIN__) "\"");
#else
...
#if defined(__linux)
        Message(
            "__linux is defined as \"" BURGER_STRINGIZE(__linux) "\"");
#else
        Message("__linux is not defined");
#endif

#if defined(__linux__)
        Message("__linux__ is defined as \"" BURGER_STRINGIZE(
            __linux__) "\"");
#else
        ...
        Message("macintosh is defined as \"" BURGER_STRINGIZE(
            macintosh) "\"");
#else
        ...
        Message("__APPLE__ is defined as \"" BURGER_STRINGIZE(
            __APPLE__) "\"");
#else
...
#if defined(__MACH__)
        Message(
            "__MACH__ is defined as \"" BURGER_STRINGIZE(__MACH__) "\"");
#else
...
#if defined(__CFM68K)
        Message(
            "__CFM68K is defined as \"" BURGER_STRINGIZE(__CFM68K) "\"");
#else
        Message("__CFM68K is not defined");
#endif

#if defined(__CFM68K__)
        Message("__CFM68K__ is defined as \"" BURGER_STRINGIZE(
            __CFM68K__) "\"");
#else
        ...
        Message("__MORPHOS__ is defined as \"" BURGER_STRINGIZE(
            __MORPHOS__) "\"");
#else
...
#if defined(__DOS__)
        Message(
            "__DOS__ is defined as \"" BURGER_STRINGIZE(__DOS__) "\"");
#else
        Message("__DOS__ is not defined");
#endif

#if defined(__MSDOS__)
        Message("__MSDOS__ is defined as \"" BURGER_STRINGIZE(
            __MSDOS__) "\"");
#else
        ...
        Message("__DOS4G__ is defined as \"" BURGER_STRINGIZE(
            __DOS4G__) "\"");
#else
...
#if defined(__X32__)
        Message(
            "__X32__ is defined as \"" BURGER_STRINGIZE(__X32__) "\"");
#else
        ...
        Message("__WIN32__ is defined as \"" BURGER_STRINGIZE(
            __WIN32__) "\"");
#else
        ...
        Message("__WINDOWS__ is defined as \"" BURGER_STRINGIZE(
            __WINDOWS__) "\"");
#else
        ...
        Message("__TOS_WIN__ is defined as \"" BURGER_STRINGIZE(
            __TOS_WIN__) "\"");
#else
        ...
        Message("_WIN32_WCE is defined as \"" BURGER_STRINGIZE(
            _WIN32_WCE) "\"");
#else
        ...
        Message("__ORBIS__ is defined as \"" BURGER_STRINGIZE(
            __ORBIS__) "\"");
#else
...
#if defined(__psp2__)
        Message(
            "__psp2__ is defined as \"" BURGER_STRINGIZE(__psp2__) "\"");
#else
...
#if defined(SDK_ARM9)
        Message(
            "SDK_ARM9 is defined as \"" BURGER_STRINGIZE(SDK_ARM9) "\"");
#else
...
#if defined(RVL_SDK)
        Message(
            "RVL_SDK is defined as \"" BURGER_STRINGIZE(RVL_SDK) "\"");
#else
        ...
        Message("__clang__ is defined as \"" BURGER_STRINGIZE(
            __clang__) "\"");
#else
...
#if defined(__ghs__)
        Message(
            "__ghs__ is defined as \"" BURGER_STRINGIZE(__ghs__) "\"");
#else
...
#if defined(__llvm__)
        Message(
            "__llvm__ is defined as \"" BURGER_STRINGIZE(__llvm__) "\"");
#else
...
#if defined(__xlc__)
        Message(
            "__xlc__ is defined as \"" BURGER_STRINGIZE(__xlc__) "\"");
#else
...
#if defined(__CC65__)
        Message(
            "__CC65__ is defined as \"" BURGER_STRINGIZE(__CC65__) "\"");
#else
        Message("__CC65__ is not defined");
#endif

#if defined(__DJGPP__)
        Message("__DJGPP__ is defined as \"" BURGER_STRINGIZE(
            __DJGPP__) "\"");
#else
...
#if defined(__GNUC__)
        Message(
            "__GNUC__ is defined as \"" BURGER_STRINGIZE(__GNUC__) "\"");
#else
...
#if defined(__LCC__)
        Message(
            "__LCC__ is defined as \"" BURGER_STRINGIZE(__LCC__) "\"");
#else
        Message("__LCC__ is not defined");
#endif

#if defined(__MWERKS__)
        Message("__MWERKS__ is defined as \"" BURGER_STRINGIZE(
            __MWERKS__) "\"");
#else
...
#if defined(__CWCC__)
        Message(
            "__CWCC__ is defined as \"" BURGER_STRINGIZE(__CWCC__) "\"");
#else
...
#if defined(__MSL__)
        Message(
            "__MSL__ is defined as \"" BURGER_STRINGIZE(__MSL__) "\"");
#else
...
#if defined(_MSC_VER)
        Message(
            "_MSC_VER is defined as \"" BURGER_STRINGIZE(_MSC_VER) "\"");
#else
        Message("_MSC_VER is not defined");
#endif

#if defined(_MSVC_LANG)
        Message("_MSVC_LANG is defined as \"" BURGER_STRINGIZE(
            _MSVC_LANG) "\"");
#else
        ...
        Message("__MINGW32__ is defined as \"" BURGER_STRINGIZE(
            __MINGW32__) "\"");
#else
        ...
        Message("__MINGW64__ is defined as \"" BURGER_STRINGIZE(
            __MINGW64__) "\"");
#else
...
#if defined(__MRC__)
        Message(
            "__MRC__ is defined as \"" BURGER_STRINGIZE(__MRC__) "\"");
#else
        ...
        Message("MPW_CPLUS is defined as \"" BURGER_STRINGIZE(
            MPW_CPLUS) "\"");
#else
...
#if defined(__SNC__)
        Message(
            "__SNC__ is defined as \"" BURGER_STRINGIZE(__SNC__) "\"");
#else
        Message("__SNC__ is not defined");
#endif

#if defined(__TINYC__)
        Message("__TINYC__ is defined as \"" BURGER_STRINGIZE(
            __TINYC__) "\"");
#else
        ...
        Message("__TURBOC__ is defined as \"" BURGER_STRINGIZE(
            __TURBOC__) "\"");
#else
        ...
        Message("__WATCOMC__ is defined as \"" BURGER_STRINGIZE(
            __WATCOMC__) "\"");
#else
...
#if defined(__ZTC__)
        Message(
            "__ZTC__ is defined as \"" BURGER_STRINGIZE(__ZTC__) "\"");
#else
        ...
        Message("__R5900__ is defined as \"" BURGER_STRINGIZE(
            __R5900__) "\"");
#else
...
#if defined(__R5900)
        Message(
            "__R5900 is defined as \"" BURGER_STRINGIZE(__R5900) "\"");
#else
...
#if defined(__MIPS__)
        Message(
            "__MIPS__ is defined as \"" BURGER_STRINGIZE(__MIPS__) "\"");
#else
...
#if defined(__PPC__)
        Message(
            "__PPC__ is defined as \"" BURGER_STRINGIZE(__PPC__) "\"");
#else
...
#if defined(_M_MPPC)
        Message(
            "_M_MPPC is defined as \"" BURGER_STRINGIZE(_M_MPPC) "\"");
#else
        ...
        Message("__ppc64__ is defined as \"" BURGER_STRINGIZE(
            __ppc64__) "\"");
#else
        ...
        Message("__ALTIVEC__ is defined as \"" BURGER_STRINGIZE(
            __ALTIVEC__) "\"");
#else
...
#if defined(_M_IX86)
        Message(
            "_M_IX86 is defined as \"" BURGER_STRINGIZE(_M_IX86) "\"");
#else
...
#if defined(__i386__)
        Message(
            "__i386__ is defined as \"" BURGER_STRINGIZE(__i386__) "\"");
#else
...
#if defined(_M_AMD64)
        Message(
            "_M_AMD64 is defined as \"" BURGER_STRINGIZE(_M_AMD64) "\"");
#else
        ...
        Message("__x86_64__ is defined as \"" BURGER_STRINGIZE(
            __x86_64__) "\"");
#else
...
#if defined(__SSE__)
        Message(
            "__SSE__ is defined as \"" BURGER_STRINGIZE(__SSE__) "\"");
#else
...
#if defined(__SSE2__)
        Message(
            "__SSE2__ is defined as \"" BURGER_STRINGIZE(__SSE2__) "\"");
#else
...
#if defined(__AVX__)
        Message(
            "__AVX__ is defined as \"" BURGER_STRINGIZE(__AVX__) "\"");
#else
...
#if defined(__AVX2__)
        Message(
            "__AVX2__ is defined as \"" BURGER_STRINGIZE(__AVX2__) "\"");
#else
...
#if defined(_M_IA64)
        Message(
            "_M_IA64 is defined as \"" BURGER_STRINGIZE(_M_IA64) "\"");
#else
        Message("_M_IA64 is not defined");
#endif

#if defined(_M_MRX000)
        Message("_M_MRX000 is defined as \"" BURGER_STRINGIZE(
            _M_MRX000) "\"");
#else
...
#if defined(_M_M68K)
        Message(
            "_M_M68K is defined as \"" BURGER_STRINGIZE(_M_M68K) "\"");
#else
        Message("_M_M68K is not defined");
#endif

#if defined(__MC68K__)
        Message("__MC68K__ is defined as \"" BURGER_STRINGIZE(
            __MC68K__) "\"");
#else
...
#if defined(__m68k__)
        Message(
            "__m68k__ is defined as \"" BURGER_STRINGIZE(__m68k__) "\"");
#else
...
#if defined(mc68881)
        Message(
            "mc68881 is defined as \"" BURGER_STRINGIZE(mc68881) "\"");
#else
        Message("mc68881 is not defined");
#endif

#if defined(__MC68881__)
        Message("__MC68881__ is defined as \"" BURGER_STRINGIZE(
            __MC68881__) "\"");
#else
...
#if defined(__arm__)
        Message(
            "__arm__ is defined as \"" BURGER_STRINGIZE(__arm__) "\"");
#else
        Message("__arm__ is not defined");
#endif

#if defined(__arm64__)
        Message("__arm64__ is defined as \"" BURGER_STRINGIZE(
            __arm64__) "\"");
#else
        ...
        Message("__aarch64__ is defined as \"" BURGER_STRINGIZE(
            __aarch64__) "\"");
#else
...
static void BURGER_API ShowMacros(uint_t uVerbose)
{
    if (uVerbose & VERBOSE_MACROS) {
        ...
        Message("BURGER_API is defined as \"" BURGER_STRINGIZE(
            BURGER_API) "\"");
        ...
        Message("BURGER_ASM is defined as \"" BURGER_STRINGIZE(
            BURGER_ASM) "\"");
        Message("BURGER_MAXWORDPTR is defined as \"" BURGER_STRINGIZE(
            BURGER_MAXWORDPTR) "\"");
...
static uint_t BURGER_API TestCompilerMacros(uint_t uVerbose)
{
    ...
    if (uVerbose & VERBOSE_MACROS) {
        ...
        Message(
            "BURGER_STATIC_ASSERT is defined as \"" BURGER_STRINGIZE(
...
#if defined(BURGER_MSVC)
    if (uVerbose & VERBOSE_MACROS) {
        Message("BURGER_MSVC is defined as \"" BURGER_STRINGIZE(
            BURGER_MSVC) "\"");
    }
    ++uTest;
#endif
...
static uint_t BURGER_API TestCPUMacros(uint_t uVerbose)
{
    ...
    if (uVerbose & VERBOSE_MACROS) {
        ...
        Message(
            "BURGER_NEED_UINTPTR_REMAP is defined as \"" BURGER_STRINGIZE(
