...
.PHONY: Debuglnx
Debuglnx:
	@$(MAKE) -e --no-print-directory CONFIG=Debug TARGET=lnx -f unittestsmaklnx.mak bin/unittestsmaklnxdbg

.PHONY: clean_Debuglnx
clean_Debuglnx:
	@-rm -f $(EXTRA_OBJS)
	@-rm -rf temp/unittestsmaklnxdbg
	@-rm -f bin/unittestsmaklnxdbg
	@if [ -d bin ] && files=$$(ls -qAL -- bin) && [ -z "$$files" ]; then rm -fd bin; fi
	@if [ -d temp ] && files=$$(ls -qAL -- temp) && [ -z "$$files" ]; then rm -fd temp; fi

.PHONY: Internallnx
Internallnx:
	@$(MAKE) -e --no-print-directory CONFIG=Internal TARGET=lnx -f unittestsmaklnx.mak bin/unittestsmaklnxint

.PHONY: clean_Internallnx
clean_Internallnx:
	@-rm -f $(EXTRA_OBJS)
	@-rm -rf temp/unittestsmaklnxint
	@-rm -f bin/unittestsmaklnxint
	@if [ -d bin ] && files=$$(ls -qAL -- bin) && [ -z "$$files" ]; then rm -fd bin; fi
	@if [ -d temp ] && files=$$(ls -qAL -- temp) && [ -z "$$files" ]; then rm -fd temp; fi

.PHONY: Releaselnx
Releaselnx:
	@$(MAKE) -e --no-print-directory CONFIG=Release TARGET=lnx -f unittestsmaklnx.mak bin/unittestsmaklnxrel

.PHONY: clean_Releaselnx
clean_Releaselnx:
	@-rm -f $(EXTRA_OBJS)
	@-rm -rf temp/unittestsmaklnxrel
	@-rm -f bin/unittestsmaklnxrel
	@if [ -d bin ] && files=$$(ls -qAL -- bin) && [ -z "$$files" ]; then rm -fd bin; fi
	@if [ -d temp ] && files=$$(ls -qAL -- temp) && [ -z "$$files" ]; then rm -fd temp; fi
...
LFlagsDebuglnx:= -g -lGL -luuid
LFlagsInternallnx:= -g -lGL -luuid
LFlagsReleaselnx:= -lGL -luuid
...
OBJS:= $(TEMP_DIR)/bradler16.o \
	...
	$(TEMP_DIR)/brconditionvariable.o \
	...
	$(TEMP_DIR)/brdetectmultilaunchlinux.o \
	...
	$(TEMP_DIR)/brwin437.o \
	$(TEMP_DIR)/common.o \
	$(TEMP_DIR)/floattointceil.o \
	$(TEMP_DIR)/floattointceilptr.o \
	$(TEMP_DIR)/floattointfloor.o \
	$(TEMP_DIR)/floattointfloorptr.o \
	$(TEMP_DIR)/floattointround.o \
	$(TEMP_DIR)/floattointroundptr.o \
	$(TEMP_DIR)/get_signdouble.o \
	$(TEMP_DIR)/get_signfloat.o \
	$(TEMP_DIR)/linux_sandbox.o \
	$(TEMP_DIR)/testbralgorithm.o \
	$(TEMP_DIR)/testbrcodelibrary.o \
	$(TEMP_DIR)/testbrcompression.o \
	$(TEMP_DIR)/testbrdisplay.o \
	$(TEMP_DIR)/testbrendian.o \
	$(TEMP_DIR)/testbrfileloaders.o \
	$(TEMP_DIR)/testbrfilemanager.o \
	$(TEMP_DIR)/testbrfixedpoint.o \
	$(TEMP_DIR)/testbrfloatingpoint.o \
	$(TEMP_DIR)/testbrhashes.o \
	$(TEMP_DIR)/testbrmatrix3d.o \
	$(TEMP_DIR)/testbrmatrix4d.o \
	$(TEMP_DIR)/testbrnumberto.o \
	$(TEMP_DIR)/testbrpoweroftwo.o \
	$(TEMP_DIR)/testbrprintf.o \
	$(TEMP_DIR)/testbrstaticrtti.o \
	$(TEMP_DIR)/testbrstrings.o \
	$(TEMP_DIR)/testbrtimedate.o \
	$(TEMP_DIR)/testbrtypes.o \
	$(TEMP_DIR)/testcharset.o \
	$(TEMP_DIR)/testmacros.o \
...
DEPS:= $(TEMP_DIR)/bradler16.d \
	...
	$(TEMP_DIR)/brconditionvariable.d \
	...
	$(TEMP_DIR)/brdetectmultilaunchlinux.d \
	...
	$(TEMP_DIR)/brwin437.d \
	$(TEMP_DIR)/common.d \
	$(TEMP_DIR)/floattointceil.d \
	$(TEMP_DIR)/floattointceilptr.d \
	$(TEMP_DIR)/floattointfloor.d \
	$(TEMP_DIR)/floattointfloorptr.d \
	$(TEMP_DIR)/floattointround.d \
	$(TEMP_DIR)/floattointroundptr.d \
	$(TEMP_DIR)/get_signdouble.d \
	$(TEMP_DIR)/get_signfloat.d \
	$(TEMP_DIR)/linux_sandbox.d \
	$(TEMP_DIR)/testbralgorithm.d \
	$(TEMP_DIR)/testbrcodelibrary.d \
	$(TEMP_DIR)/testbrcompression.d \
	$(TEMP_DIR)/testbrdisplay.d \
	$(TEMP_DIR)/testbrendian.d \
	$(TEMP_DIR)/testbrfileloaders.d \
	$(TEMP_DIR)/testbrfilemanager.d \
	$(TEMP_DIR)/testbrfixedpoint.d \
	$(TEMP_DIR)/testbrfloatingpoint.d \
	$(TEMP_DIR)/testbrhashes.d \
	$(TEMP_DIR)/testbrmatrix3d.d \
	$(TEMP_DIR)/testbrmatrix4d.d \
	$(TEMP_DIR)/testbrnumberto.d \
	$(TEMP_DIR)/testbrpoweroftwo.d \
	$(TEMP_DIR)/testbrprintf.d \
	$(TEMP_DIR)/testbrstaticrtti.d \
	$(TEMP_DIR)/testbrstrings.d \
	$(TEMP_DIR)/testbrtimedate.d \
	$(TEMP_DIR)/testbrtypes.d \
	$(TEMP_DIR)/testcharset.d \
	$(TEMP_DIR)/testmacros.d \
...
../source/ansi/brcapturestdout.cpp \
../source/ansi/brfileansihelpers.cpp \
../source/ansi/brmemoryansi.cpp \
../source/ansi/brstdouthelpers.cpp \
../source/asm/gnux64/floattointceil.x64 \
../source/asm/gnux64/floattointceilptr.x64 \
../source/asm/gnux64/floattointfloor.x64 \
../source/asm/gnux64/floattointfloorptr.x64 \
../source/asm/gnux64/floattointround.x64 \
../source/asm/gnux64/floattointroundptr.x64 \
../source/asm/gnux64/get_signdouble.x64 \
../source/asm/gnux64/get_signfloat.x64 \
../source/asm/gnux64/xgetbv.x64 \
../source/audio/bralaw.cpp \
../source/audio/brimportit.cpp \
../source/audio/brimports3m.cpp \
../source/audio/brimportxm.cpp \
../source/audio/brmace.cpp \
../source/audio/brmicrosoftadpcm.cpp \
../source/audio/brsequencer.cpp \
../source/audio/brsound.cpp \
../source/audio/brsoundbufferrez.cpp \
../source/audio/brsounddecompress.cpp \
../source/audio/brulaw.cpp \
../source/commandline/brcommandparameter.cpp \
../source/commandline/brcommandparameterbooltrue.cpp \
../source/commandline/brcommandparameterstring.cpp \
../source/commandline/brcommandparameterwordptr.cpp \
../source/commandline/brconsolemanager.cpp \
../source/commandline/brgameapp.cpp \
../source/compression/bradler16.cpp \
../source/compression/bradler32.cpp \
../source/compression/brcompress.cpp \
../source/compression/brcompressdeflate.cpp \
../source/compression/brcompresslbmrle.cpp \
../source/compression/brcompresslzss.cpp \
../source/compression/brcrc16.cpp \
../source/compression/brcrc32.cpp \
../source/compression/brdecompress.cpp \
../source/compression/brdecompressdeflate.cpp \
../source/compression/brdecompresslbmrle.cpp \
../source/compression/brdecompresslzss.cpp \
../source/compression/brdjb2hash.cpp \
../source/compression/brdxt1.cpp \
../source/compression/brdxt3.cpp \
../source/compression/brdxt5.cpp \
../source/compression/brgost.cpp \
../source/compression/brhashmap.cpp \
../source/compression/brmd2.cpp \
../source/compression/brmd4.cpp \
../source/compression/brmd5.cpp \
../source/compression/brpackfloat.cpp \
../source/compression/brsdbmhash.cpp \
../source/compression/brsha1.cpp \
../source/compression/brunpackbytes.cpp \
../source/file/brdirectorysearch.cpp \
../source/file/brfile.cpp \
../source/file/brfileapf.cpp \
../source/file/brfilebmp.cpp \
../source/file/brfiledds.cpp \
../source/file/brfilegif.cpp \
../source/file/brfileini.cpp \
../source/file/brfilelbm.cpp \
../source/file/brfilemanager.cpp \
../source/file/brfilemp3.cpp \
../source/file/brfilename.cpp \
../source/file/brfilepcx.cpp \
../source/file/brfilepng.cpp \
../source/file/brfiletga.cpp \
../source/file/brfilexml.cpp \
../source/file/brinputmemorystream.cpp \
../source/file/broutputmemorystream.cpp \
../source/file/brrezfile.cpp \
../source/flashplayer/brflashaction.cpp \
../source/flashplayer/brflashactionvalue.cpp \
../source/flashplayer/brflashavm2.cpp \
../source/flashplayer/brflashcolortransform.cpp \
../source/flashplayer/brflashdisasmactionscript.cpp \
../source/flashplayer/brflashmanager.cpp \
../source/flashplayer/brflashmatrix23.cpp \
../source/flashplayer/brflashrect.cpp \
../source/flashplayer/brflashrgba.cpp \
../source/flashplayer/brflashstream.cpp \
../source/flashplayer/brflashutils.cpp \
../source/graphics/brdisplay.cpp \
../source/graphics/brdisplayobject.cpp \
../source/graphics/brdisplayopengl.cpp \
../source/graphics/brdisplayopenglsoftware8.cpp \
../source/graphics/brfont.cpp \
../source/graphics/brfont4bit.cpp \
../source/graphics/brimage.cpp \
../source/graphics/brpalette.cpp \
../source/graphics/brpoint2d.cpp \
../source/graphics/brrect.cpp \
../source/graphics/brrenderer.cpp \
../source/graphics/brrenderersoftware16.cpp \
../source/graphics/brrenderersoftware8.cpp \
../source/graphics/brshape8bit.cpp \
../source/graphics/brtexture.cpp \
../source/graphics/brtextureopengl.cpp \
../source/graphics/brvertexbuffer.cpp \
../source/graphics/brvertexbufferopengl.cpp \
../source/graphics/effects/breffect.cpp \
../source/graphics/effects/breffect2d.cpp \
../source/graphics/effects/breffectpositiontexturecolor.cpp \
../source/graphics/effects/breffectstaticpositiontexture.cpp \
../source/graphics/effects/brshaders.cpp \
../source/graphics/shaders/brshader2dccolor.cpp \
../source/graphics/shaders/brshader2dcolorvertex.cpp \
../source/graphics/vulkan/brvulkanerrors.cpp \
../source/input/brjoypad.cpp \
../source/input/brkeyboard.cpp \
../source/input/brmouse.cpp \
../source/lowlevel/bralgorithm.cpp \
../source/lowlevel/brargumenttype.cpp \
../source/lowlevel/brarray.cpp \
../source/lowlevel/brassert.cpp \
../source/lowlevel/bratomic.cpp \
../source/lowlevel/brautorepeat.cpp \
../source/lowlevel/brbase.cpp \
../source/lowlevel/brcodelibrary.cpp \
../source/lowlevel/brconditionvariable.cpp \
../source/lowlevel/brdebug.cpp \
../source/lowlevel/brdetectmultilaunch.cpp \
../source/lowlevel/brdoublelinkedlist.cpp \
../source/lowlevel/brendian.cpp \
../source/lowlevel/brerror.cpp \
../source/lowlevel/brglobals.cpp \
../source/lowlevel/brgridindex.cpp \
../source/lowlevel/brguid.cpp \
../source/lowlevel/brintrinsics.cpp \
../source/lowlevel/brlastinfirstout.cpp \
../source/lowlevel/brlinkedlistobject.cpp \
../source/lowlevel/brlinkedlistpointer.cpp \
../source/lowlevel/brmutex.cpp \
../source/lowlevel/broscursor.cpp \
...
../source/lowlevel/brsmartpointer.cpp \
../source/lowlevel/brstaticrtti.cpp \
../source/lowlevel/brstructs.cpp \
../source/lowlevel/brtemplates.cpp \
../source/lowlevel/brthread.cpp \
../source/lowlevel/brtick.cpp \
../source/lowlevel/brtimedate.cpp \
../source/lowlevel/brtypes.cpp \
../source/lowlevel/brvectortypes.cpp \
../source/math/brearcliptriangulate.cpp \
../source/math/brfixedmatrix3d.cpp \
../source/math/brfixedmatrix4d.cpp \
../source/math/brfixedpoint.cpp \
../source/math/brfixedvector2d.cpp \
../source/math/brfixedvector3d.cpp \
../source/math/brfixedvector4d.cpp \
../source/math/brfloatingpoint.cpp \
../source/math/brfphalf.cpp \
../source/math/brfpinfo.cpp \
../source/math/brfplargeint.cpp \
../source/math/brfpprintinfo.cpp \
../source/math/brmatrix3d.cpp \
../source/math/brmatrix4d.cpp \
../source/math/brpoweroftwo.cpp \
../source/math/brsinecosine.cpp \
../source/math/brvector2d.cpp \
../source/math/brvector3d.cpp \
../source/math/brvector4d.cpp \
../source/memory/brglobalmemorymanager.cpp \
../source/memory/brmemoryhandle.cpp \
../source/memory/brmemorymanager.cpp \
../source/platforms/linux/brconsolemanagerlinux.cpp \
../source/platforms/linux/brdetectmultilaunchlinux.cpp \
../source/platforms/linux/brfilemanagerlinux.cpp \
../source/platforms/linux/brfilenamelinux.cpp \
../source/platforms/linux/brglobalslinux.cpp \
../source/platforms/linux/brguidlinux.cpp \
../source/platforms/linux/brosstringfunctionslinux.cpp \
../source/platforms/linux/brthreadlinux.cpp \
../source/platforms/linux/linux_sandbox.cpp \
../source/platforms/unix/brcodelibraryunix.cpp \
../source/platforms/unix/brconditionvariableunix.cpp \
../source/platforms/unix/brdebugunix.cpp \
../source/platforms/unix/brdirectorysearchunix.cpp \
../source/platforms/unix/brfilemanagerunix.cpp \
../source/platforms/unix/brfilenameunix.cpp \
...
../source/platforms/unix/brunixtypes.cpp \
../source/platforms/unix/unix_dbus.cpp \
../source/platforms/unix/unix_dbusinstance.cpp \
../source/platforms/unix/unix_shims.cpp \
../source/platforms/unix/unix_sleep.cpp \
../source/random/brmersennetwist.cpp \
../source/random/brrandom.cpp \
../source/random/brrandombase.cpp \
../source/text/brasciito.cpp \
../source/text/brcodepage.cpp \
../source/text/brisolatin1.cpp \
../source/text/brlocalization.cpp \
../source/text/brmacromanus.cpp \
../source/text/brmemoryfunctions.cpp \
../source/text/brnumberstring.cpp \
../source/text/brnumberstringhex.cpp \
../source/text/brnumberto.cpp \
../source/text/brosstringfunctions.cpp \
../source/text/brprintf.cpp \
...
../source/text/brutf8.cpp \
../source/text/brwin1252.cpp \
../source/text/brwin437.cpp \
../unittest/common.cpp \
../unittest/testbralgorithm.cpp \
../unittest/testbrcodelibrary.cpp \
../unittest/testbrcompression.cpp \
../unittest/testbrdisplay.cpp \
../unittest/testbrendian.cpp \
../unittest/testbrfileloaders.cpp \
../unittest/testbrfilemanager.cpp \
../unittest/testbrfixedpoint.cpp \
../unittest/testbrfloatingpoint.cpp \
../unittest/testbrhashes.cpp \
../unittest/testbrmatrix3d.cpp \
../unittest/testbrmatrix4d.cpp \
../unittest/testbrnumberto.cpp \
../unittest/testbrpoweroftwo.cpp \
../unittest/testbrprintf.cpp \
../unittest/testbrstaticrtti.cpp \
../unittest/testbrstrings.cpp \
../unittest/testbrtimedate.cpp \
../unittest/testbrtypes.cpp \
../unittest/testcharset.cpp \
../unittest/testmacros.cpp \
	: ;
...
$(TEMP_DIR)/floattointceil.o: ../source/asm/gnux64/floattointceil.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/floattointceilptr.o: ../source/asm/gnux64/floattointceilptr.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/floattointfloor.o: ../source/asm/gnux64/floattointfloor.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/floattointfloorptr.o: ../source/asm/gnux64/floattointfloorptr.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/floattointround.o: ../source/asm/gnux64/floattointround.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/floattointroundptr.o: ../source/asm/gnux64/floattointroundptr.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/get_signdouble.o: ../source/asm/gnux64/get_signdouble.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/get_signfloat.o: ../source/asm/gnux64/get_signfloat.x64 ; $(BUILD_ASMX64)

$(TEMP_DIR)/xgetbv.o: ../source/asm/gnux64/xgetbv.x64 ; $(BUILD_ASMX64)
...
$(TEMP_DIR)/brconditionvariable.o: ../source/lowlevel/brconditionvariable.cpp ; $(BUILD_CPP)
...
$(TEMP_DIR)/brdoublelinkedlist.o: ../source/lowlevel/brdoublelinkedlist.cpp ; $(BUILD_CPP)
...
$(TEMP_DIR)/brmutex.o: ../source/lowlevel/brmutex.cpp ; $(BUILD_CPP)
...
$(TEMP_DIR)/brvectortypes.o: ../source/lowlevel/brvectortypes.cpp ; $(BUILD_CPP)
...
$(TEMP_DIR)/brpoweroftwo.o: ../source/math/brpoweroftwo.cpp ; $(BUILD_CPP)
...
$(TEMP_DIR)/brdetectmultilaunchlinux.o: ../source/platforms/linux/brdetectmultilaunchlinux.cpp ; $(BUILD_CPP)
...
$(TEMP_DIR)/common.o: ../unittest/common.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbralgorithm.o: ../unittest/testbralgorithm.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrcodelibrary.o: ../unittest/testbrcodelibrary.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrcompression.o: ../unittest/testbrcompression.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrdisplay.o: ../unittest/testbrdisplay.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrendian.o: ../unittest/testbrendian.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrfileloaders.o: ../unittest/testbrfileloaders.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrfilemanager.o: ../unittest/testbrfilemanager.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrfixedpoint.o: ../unittest/testbrfixedpoint.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrfloatingpoint.o: ../unittest/testbrfloatingpoint.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrhashes.o: ../unittest/testbrhashes.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrmatrix3d.o: ../unittest/testbrmatrix3d.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrmatrix4d.o: ../unittest/testbrmatrix4d.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrnumberto.o: ../unittest/testbrnumberto.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrpoweroftwo.o: ../unittest/testbrpoweroftwo.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrprintf.o: ../unittest/testbrprintf.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrstaticrtti.o: ../unittest/testbrstaticrtti.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrstrings.o: ../unittest/testbrstrings.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrtimedate.o: ../unittest/testbrtimedate.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testbrtypes.o: ../unittest/testbrtypes.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testcharset.o: ../unittest/testcharset.cpp ; $(BUILD_CPP)

$(TEMP_DIR)/testmacros.o: ../unittest/testmacros.cpp ; $(BUILD_CPP)
...
bin/unittestsmaklnxdbg: $(EXTRA_OBJS) $(OBJS) unittestsmaklnx.mak | bin
	@echo Performing link...
	@$(LINK) -o $@ $(OBJS) $(LFlags$(CONFIG)$(TARGET))

bin/unittestsmaklnxint: $(EXTRA_OBJS) $(OBJS) unittestsmaklnx.mak | bin
	@echo Performing link...
	@$(LINK) -o $@ $(OBJS) $(LFlags$(CONFIG)$(TARGET))

bin/unittestsmaklnxrel: $(EXTRA_OBJS) $(OBJS) unittestsmaklnx.mak | bin
	@echo Performing link...
	@$(LINK) -o $@ $(OBJS) $(LFlags$(CONFIG)$(TARGET))
