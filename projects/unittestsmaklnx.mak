...
OBJS:= $(TEMP_DIR)/bradler16.o \
	...
	$(TEMP_DIR)/brcriticalsectionunix.o \
	$(TEMP_DIR)/brdebug.o \
...
DEPS:= $(TEMP_DIR)/bradler16.d \
	...
	$(TEMP_DIR)/brcriticalsectionunix.d \
	$(TEMP_DIR)/brdebug.d \
...
$(TEMP_DIR)/brcriticalsectionunix.o: ../source/platforms/unix/brcriticalsectionunix.cpp ; $(BUILD_CPP)
