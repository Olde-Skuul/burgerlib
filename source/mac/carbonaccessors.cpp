...
BURGER_INLINE Ptr RoundUp(Ptr pInput)
{
...
// uint32_t IsCurrentTSMDocumentUnicode(void)
//{
//    ProcInfoType uType = kD0DispatchedPascalStackBased |
//    RESULT_SIZE(SIZE_CODE(sizeof(Boolean))) |
//    REGISTER_RESULT_LOCATION(kRegisterD2); return
//    static_cast<Boolean>(CALL_ONE_PARAMETER_UPP(uType,33));
//}
