        ...
        if (!pLocals->m_uFragError) {
            REF CallUniversalProc =
                (pascal long (*)(UniversalProcPtr, ProcInfoType,
                    ...))pInterfaceLib->GetFunction("CallUniversalProc");
            REF NGetTrapAddress = (pascal UniversalProcPtr(*)(
                UInt16, TrapType))pInterfaceLib->GetFunction("NGetTrapAddress");
            ...
            REF CrsrDevMove = (pascal OSErr(*)(CursorDevice*, long,
                long))pInterfaceLib->GetFunction("CrsrDevMove");
            REF CrsrDevMoveTo = (pascal OSErr(*)(CursorDevice*, long,
                long))pInterfaceLib->GetFunction("CrsrDevMoveTo");
            REF CrsrDevFlush = (pascal OSErr(*)(
                CursorDevice*))pInterfaceLib->GetFunction("CrsrDevFlush");
            REF CrsrDevButtons = (pascal OSErr(*)(CursorDevice*,
                short))pInterfaceLib->GetFunction("CrsrDevButtons");
            REF CrsrDevButtonDown = (pascal OSErr(*)(
                CursorDevice*))pInterfaceLib->GetFunction("CrsrDevButtonDown");
            REF CrsrDevButtonUp = (pascal OSErr(*)(
                CursorDevice*))pInterfaceLib->GetFunction("CrsrDevButtonUp");
            REF CrsrDevButtonOp = (pascal OSErr(*)(CursorDevice*, short, short,
                long))pInterfaceLib->GetFunction("CrsrDevButtonOp");
            REF CrsrDevSetButtons = (pascal OSErr(*)(CursorDevice*,
                short))pInterfaceLib->GetFunction("CrsrDevSetButtons");
            REF CrsrDevSetAcceleration = (pascal OSErr(*)(CursorDevice*,
                long))pInterfaceLib->GetFunction("CrsrDevSetAcceleration");
            REF CrsrDevDoubleTime = (pascal OSErr(*)(CursorDevice*,
                long))pInterfaceLib->GetFunction("CrsrDevDoubleTime");
            REF CrsrDevUnitsPerInch = (pascal OSErr(*)(CursorDevice*,
                long))pInterfaceLib->GetFunction("CrsrDevUnitsPerInch");
            REF CrsrDevNextDevice = (pascal OSErr(*)(
                CursorDevice**))pInterfaceLib->GetFunction("CrsrDevNextDevice");
            REF CrsrDevNewDevice = (pascal OSErr(*)(
                CursorDevice**))pInterfaceLib->GetFunction("CrsrDevNewDevice");
            REF CrsrDevDisposeDevice =
                (pascal OSErr(*)(CursorDevice*))pInterfaceLib->GetFunction(
