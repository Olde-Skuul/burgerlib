...
/*! ************************************
	...
	Converts the contents of a Burger::Point2D_t into a MacOSX
	_NSPoint structure. Since it's converting an int into a float,
	data loss could occur.
...
/*! ************************************
	...
	Converts the contents of a MacOSX _NSPoint structure
	into a Burger::Point2D_t. Since it's converting a float to an int,
	data loss could occur.
