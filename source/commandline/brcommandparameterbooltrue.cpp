...
/*! ************************************
    ...
    \fn Burger::CommandParameterBooleanTrue::CommandParameterBooleanTrue(const
        char *pHelp, const char *const *ppParameterName,
...
/*! ************************************
    ...
    \fn Burger::CommandParameterBooleanTrue::CommandParameterBooleanTrue(const
        char *pHelp,const char *pParameterName)
...
int Burger::CommandParameterBooleanTrue::Action(
    int /* argc */, const char** /* argv */) BURGER_NOEXCEPT
{
    m_bValue = TRUE;
    return 1;
}
...
/*! ************************************
    ...
    \fn Burger::CommandParameterBooleanTrue::GetValue(void) const
