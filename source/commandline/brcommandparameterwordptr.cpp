...
/*! ************************************
	...
	\fn Burger::CommandParameterWordPtr::CommandParameterWordPtr(const char *pHelp,const char **ppParameterName,
		WordPtr uParameterCount,WordPtr uDefault,WordPtr uMin=0,WordPtr uMax=BURGER_MAXWORDPTR)
...
/*! ************************************
	...
	\fn Burger::CommandParameterWordPtr::CommandParameterWordPtr(const char *pHelp,
		const char *pParameterName,WordPtr uDefault,WordPtr uMin=0,WordPtr uMax=BURGER_MAXWORDPTR) :
...
/*! ************************************
	...
	If there is a parameter in the list, parse it as a numeric
	string. Test against the valid range and return either
	-1 if an error occurred or 2 to remove the 2 command entries.
...
int Burger::CommandParameterWordPtr::Action(int argc,const char **argv)
{
...
/*! ************************************
	...
	\fn WordPtr Burger::CommandParameterWordPtr::GetValue(void) const 
