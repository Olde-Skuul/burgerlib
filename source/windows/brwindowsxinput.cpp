...
uint32_t BURGER_API Burger::Windows::XInputGetCapabilities(
    uint32_t dwUserIndex, uint32_t dwFlags, _XINPUT_CAPABILITIES* pCapabilities)
{
    // Get the function pointer
...
uint32_t BURGER_API Burger::Windows::XInputGetDSoundAudioDeviceGuids(
...
uint32_t BURGER_API Burger::Windows::XInputGetAudioDeviceIds(uint32_t dwUserIndex,
...
uint32_t BURGER_API Burger::Windows::XInputGetBatteryInformation(
    uint32_t dwUserIndex, uint_t devType,
...
uint32_t BURGER_API Burger::Windows::XInputGetKeystroke(
