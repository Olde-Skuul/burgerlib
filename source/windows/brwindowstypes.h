...
public:
    ...
    static uint_t BURGER_API DirectInputCreateA(HINSTANCE__* hInst,
        uint32_t uVersion, IDirectInputA** ppOutput, IUnknown* pOuter = nullptr);
    static uint_t BURGER_API DirectInputCreateW(HINSTANCE__* hInst,
        uint32_t uVersion, IDirectInputW** ppOutput, IUnknown* pOuter = nullptr);
    ...
    static uint32_t BURGER_API XInputGetDSoundAudioDeviceGuids(
        uint32_t dwUserIndex, GUID* pDSoundRenderGuid, GUID* pDSoundCaptureGuid);
    ...
    static uint32_t BURGER_API XInputGetKeystroke(
        uint32_t dwUserIndex, uint32_t dwReserved, _XINPUT_KEYSTROKE* pKeystroke);
    ...
    static int BURGER_API D3DPERF_BeginEvent(uint32_t col, const uint16_t* wszName);
    static int BURGER_API D3DPERF_EndEvent(void);
    static void BURGER_API D3DPERF_SetMarker(uint32_t col, const uint16_t* wszName);
    static void BURGER_API D3DPERF_SetRegion(uint32_t col, const uint16_t* wszName);
    ...
    // WINMM.dll
    static uint32_t BURGER_API timeGetTime(void);
    ...
    // VERSION.dll
    static uint_t BURGER_API VerQueryValueA(
    ...
    static uint_t BURGER_API GetFileVersionInfoA(
    ...
    static uint_t BURGER_API SetupDiGetDeviceInterfaceDetailA(void* DeviceInfoSet,
    ...
    static uint_t BURGER_API SetupDiGetDeviceInterfaceDetailW(void* DeviceInfoSet,
        _SP_DEVICE_INTERFACE_DATA* DeviceInterfaceData,
