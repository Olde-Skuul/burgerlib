...
BURGER_INLINE void PrintHex(int iInput) { PrintHex(static_cast<UInt2int_t>(iInput)); }
BURGER_INLINE void PrintHex(long iInput) { PrintHex(static_cast<ULong2int_t>(iInput)); }
...
BURGER_INLINE void PrintHex(wchar_t iInput) { PrintHex(static_cast<uint16_t>(iInput)); }
#endif

#if defined(BURGER_INT32_T_IS_LONG)
BURGER_INLINE void PrintHex(unsigned int iInput) { PrintHex(static_cast<UInt2int_t>(iInput)); }
#elif (BURGER_SIZEOF_LONG==4)
BURGER_INLINE void PrintHex(unsigned long iInput) { PrintHex(static_cast<ULong2int_t>(iInput)); }
#endif
// clang-format on
