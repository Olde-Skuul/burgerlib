...
extern uint16_t BURGER_API read_big_uint16(FILE* fp);
extern uint32_t BURGER_API read_big_uint32(FILE* fp);
...
extern uint16_t BURGER_API read_little_uint16(FILE* fp);
extern uint32_t BURGER_API read_little_uint32(FILE* fp);
...
extern uint_t BURGER_API read_c_string(FILE* fp, char* pInput, uintptr_t uLength);
extern uintptr_t BURGER_API GetSize(FILE* fp);
extern uint64_t BURGER_API GetSize64(FILE* fp);
extern eError BURGER_API SaveFile(
	FILE* fp, const void* pData, uintptr_t uLength);
