...
/*! ************************************
	...
	This class manages keyboard input down to the individual key cap. It's main
	use is to use the keyboard as a gaming input device. Emphasis is on speed,
	...
	scan codes that can be monitored. Each byte will contain the current status
	of the key by scan code. The lowest bit (mask with 0x01) will determine the
	key down status at the current moment in time. Bit #1 (mask with 0x02) is
	set when the key is pressed but never cleared unless you call a function
...
/*! ************************************
	...
	When these keys are pressed, they return these specific Unicode compatible
	"ASCII" codes.
...
/*! ************************************
	...
	All platforms will have their keyboard scan codes mapped to these
	enumerations. It allows an application to save a keyboard mapping file on
	one platform and read it in on another and have the keys map properly.
...
/*! ************************************
	...
	When a keyboard event is generated, a set of flags can be attached to denote
	any type of modification that was applied to the keystroke at the moment of
	press.
...
/***************************************
	...
	Array to convert scan codes to human readable text First entry is a pointer
	to the text, the second is the associated scan code. There can be multiple
	entries from conversion to a scan code, however only the first instance that
	matches a scan code will be use for scan code to ASCII conversion.
...
static const ScanEntry_t g_ScanCodeNames[] = {
	...
	{"Esc", Burger::Keyboard::SC_ESCAPE}, {"0", Burger::Keyboard::SC_0},
	{"1", Burger::Keyboard::SC_1}, {"2", Burger::Keyboard::SC_2},
	{"3", Burger::Keyboard::SC_3}, {"4", Burger::Keyboard::SC_4},
	{"5", Burger::Keyboard::SC_5}, {"6", Burger::Keyboard::SC_6},
	{"7", Burger::Keyboard::SC_7}, {"8", Burger::Keyboard::SC_8},
	{"9", Burger::Keyboard::SC_9}, {"A", Burger::Keyboard::SC_A},
	{"B", Burger::Keyboard::SC_B}, {"C", Burger::Keyboard::SC_C},
	{"D", Burger::Keyboard::SC_D}, {"E", Burger::Keyboard::SC_E},
	{"F", Burger::Keyboard::SC_F}, {"G", Burger::Keyboard::SC_G},
	{"H", Burger::Keyboard::SC_H}, {"I", Burger::Keyboard::SC_I},
	{"J", Burger::Keyboard::SC_J}, {"K", Burger::Keyboard::SC_K},
	{"L", Burger::Keyboard::SC_L}, {"M", Burger::Keyboard::SC_M},
	{"N", Burger::Keyboard::SC_N}, {"O", Burger::Keyboard::SC_O},
	{"P", Burger::Keyboard::SC_P}, {"Q", Burger::Keyboard::SC_Q},
	{"R", Burger::Keyboard::SC_R}, {"S", Burger::Keyboard::SC_S},
	{"T", Burger::Keyboard::SC_T}, {"U", Burger::Keyboard::SC_U},
	{"V", Burger::Keyboard::SC_V}, {"W", Burger::Keyboard::SC_W},
	{"X", Burger::Keyboard::SC_X}, {"Y", Burger::Keyboard::SC_Y},
	{"Z", Burger::Keyboard::SC_Z}, {"F1", Burger::Keyboard::SC_F1},
	{"F2", Burger::Keyboard::SC_F2}, {"F3", Burger::Keyboard::SC_F3},
	{"F4", Burger::Keyboard::SC_F4}, {"F5", Burger::Keyboard::SC_F5},
	{"F6", Burger::Keyboard::SC_F6}, {"F7", Burger::Keyboard::SC_F7},
	{"F8", Burger::Keyboard::SC_F8}, {"F9", Burger::Keyboard::SC_F9},
	{"F10", Burger::Keyboard::SC_F10}, {"F11", Burger::Keyboard::SC_F11},
	{"F12", Burger::Keyboard::SC_F12}, {"-", Burger::Keyboard::SC_MINUS},
	{"=", Burger::Keyboard::SC_PLUS},
	{"BakSpc", Burger::Keyboard::SC_BACKSPACE},
	{"Tab", Burger::Keyboard::SC_TAB}, {"[", Burger::Keyboard::SC_LEFTBRACE},
	{"]", Burger::Keyboard::SC_RIGHTBRACE},
	{";", Burger::Keyboard::SC_SEMICOLON}, {"'", Burger::Keyboard::SC_QUOTE},
	{"`", Burger::Keyboard::SC_TILDE}, {"\\", Burger::Keyboard::SC_BACKSLASH},
	{",", Burger::Keyboard::SC_COMMA}, {".", Burger::Keyboard::SC_PERIOD},
	{"/", Burger::Keyboard::SC_SLASH}, {"Enter", Burger::Keyboard::SC_RETURN},
	...
	{"Pause", Burger::Keyboard::SC_PAUSE}, {"Up", Burger::Keyboard::SC_UPARROW},
	...
	{"Home", Burger::Keyboard::SC_HOME}, {"End", Burger::Keyboard::SC_END},
...
static const ScanCodeToAscii_t
	g_ScanCodeTranslation[Burger::Keyboard::SC_EXTRA + 1] = {
		{0, 0, 0x00},           // SC_INVALID
		{'a', 'A', 0x01},       // SC_A
		{'b', 'B', 0x02},       // SC_B
		{'c', 'C', 0x03},       // SC_C
		...
		{'=', '+', 0x00},       // SC_PLUS
		{Burger::Keyboard::ASCII_BACKSPACE, Burger::Keyboard::ASCII_BACKSPACE,
			0x00},        // SC_BACKSPACE
		{'[', '{', 0x00}, // SC_RIGHTBRACE
		{']', '}', 0x00}, // SC_LEFTBRACE
		{Burger::Keyboard::ASCII_RETURN, Burger::Keyboard::ASCII_RETURN,
			0x00},         // SC_RETURN
		{'\'', '"', 0x00}, // SC_QUOTE
		{';', ':', 0x00},  // SC_COLON
		{'\\', '|', 0x00}, // SC_VERTBAR
		...
		{'.', '>', 0x00},  // SC_PERIOD
		{'/', '?', 0x00},  // SC_SLASH
		{Burger::Keyboard::ASCII_TAB, Burger::Keyboard::ASCII_TAB,
			0x00}, // SC_TAB
		{Burger::Keyboard::ASCII_SPACE, Burger::Keyboard::ASCII_SPACE,
			0x00},              // SC_SPACE
		{0x0000, 0x0000, 0x00}, // SC_POWERBOOKENTER
		{Burger::Keyboard::ASCII_ESCAPE, Burger::Keyboard::ASCII_ESCAPE,
			0x00},              // SC_ESCAPE
		...
		{'/', '/', 0x00},       // SC_KEYPADSLASH
		{Burger::Keyboard::ASCII_ENTER, Burger::Keyboard::ASCII_ENTER,
			0x00},                                       // SC_KEYPADENTER
		{'-', '-', 0x00},                                // SC_KEYPADMINUS
		...
		{Burger::Keyboard::ASCII_PRINTSCREEN,
			Burger::Keyboard::ASCII_PRINTSCREEN, 0x00}, // SC_PRINTSCREEN
		{Burger::Keyboard::ASCII_SCROLLLOCK, Burger::Keyboard::ASCII_SCROLLLOCK,
			0x00}, // SC_SCROLLLOCK
		{Burger::Keyboard::ASCII_PAUSE, Burger::Keyboard::ASCII_PAUSE,
			0x00}, // SC_PAUSE
		{Burger::Keyboard::ASCII_INSERT, Burger::Keyboard::ASCII_INSERT,
			0x00}, // SC_INSERT
		{Burger::Keyboard::ASCII_DELETE, Burger::Keyboard::ASCII_DELETE,
			0x00}, // SC_DELETE
		{Burger::Keyboard::ASCII_HOME, Burger::Keyboard::ASCII_HOME,
			0x00}, // SC_HOME
		{Burger::Keyboard::ASCII_END, Burger::Keyboard::ASCII_END,
			0x00}, // SC_END
		{Burger::Keyboard::ASCII_PAGEUP, Burger::Keyboard::ASCII_PAGEUP,
			0x00}, // SC_PAGEUP
		{Burger::Keyboard::ASCII_PAGEDOWN, Burger::Keyboard::ASCII_PAGEDOWN,
			0x00}, // SC_PAGEDOWN
		{Burger::Keyboard::ASCII_LEFTARROW, Burger::Keyboard::ASCII_LEFTARROW,
			0x00}, // SC_LEFTARROW
		{Burger::Keyboard::ASCII_RIGHTARROW, Burger::Keyboard::ASCII_RIGHTARROW,
			0x00}, // SC_RIGHTARROW
		{Burger::Keyboard::ASCII_DOWNARROW, Burger::Keyboard::ASCII_DOWNARROW,
			0x00}, // SC_DOWNARROW
		{Burger::Keyboard::ASCII_UPARROW, Burger::Keyboard::ASCII_UPARROW,
			0x00}, // SC_UPARROW
		...
		{Burger::Keyboard::ASCII_F10, Burger::Keyboard::ASCII_F10,
			0x00}, // SC_F10
		{Burger::Keyboard::ASCII_F11, Burger::Keyboard::ASCII_F11,
			0x00}, // SC_F11
		{Burger::Keyboard::ASCII_F12, Burger::Keyboard::ASCII_F12,
			0x00}, // SC_F12
		{Burger::Keyboard::ASCII_F13, Burger::Keyboard::ASCII_F13,
			0x00}, // SC_F13
		{Burger::Keyboard::ASCII_F14, Burger::Keyboard::ASCII_F14,
			0x00}, // SC_F14
		{Burger::Keyboard::ASCII_F15, Burger::Keyboard::ASCII_F15,
			0x00},              // SC_F15
...
/*! ************************************
	...
	Installs the heartbeat thread to periodically refresh the m_KeyArray and
	generate the lists of upcoming key events
...
/*! ************************************
	...
	See if a key is pending from the keyboard, if so, return the event without
	removing it from the queue.

	\param pEvent Pointer to a KeyEvent_t structure to receive the event.

	\return Zero if no key was pending, non-zero if a keyboard event was
		retrieved.
...
uint_t BURGER_API Burger::Keyboard::PeekKeyEvent(
	KeyEvent_t* pEvent) BURGER_NOEXCEPT
{
	Lock();
	const uint_t uIndex = m_uArrayStart; // Get the starting index
...
/*! ************************************
	...
	If a keyboard event is in the queue, return the event and remove it from the
	list.
...
uint_t BURGER_API Burger::Keyboard::GetKeyEvent(
	KeyEvent_t* pEvent) BURGER_NOEXCEPT
{
	Lock();

	// Get the starting index
	const uint_t uIndex = m_uArrayStart;
	uint_t bResult = FALSE;

	// Anything in the buffer?
	if (uIndex != m_uArrayEnd) {
		pEvent[0] = m_KeyEvents[uIndex];

		// Next key
		m_uArrayStart = (uIndex + 1) & (kBufferSize - 1);
		bResult = TRUE;
	}
	Unlock();
...
/*! ************************************
	...
	If the code is invalid, do nothing. Otherwise, clear the keyboard flags in
	the m_KeyArray
...
/*! ************************************
	...
	Scan the keyboard status array and return the scan code of the first key
	found that's held down.

	\return \ref SC_INVALID if no key was pressed or the scan code of the first
		key found
...
Burger::Keyboard::eScanCode BURGER_API Burger::Keyboard::AnyPressed(
...
/*! ************************************
	...
	If a key has been pressed, return \ref TRUE. If the key has not been pressed
	or the scan code is invalid, return \ref FALSE. This function will not clear
...
uint_t BURGER_API Burger::Keyboard::HasBeenPressed(
	eScanCode uScanCode) const BURGER_NOEXCEPT
{
	uint_t bResult = FALSE;
	if ((uScanCode != SC_INVALID) &&
		(static_cast<uint_t>(uScanCode) <
...
/*! ************************************
	...
	\brief Check if the requested key is currently or previously held down and
		clear the event.

	If a key is pressed, clear the event and return \ref TRUE, otherwise or if
	the scan code is invalid, return \ref FALSE
...
uint_t BURGER_API Burger::Keyboard::HasBeenPressedClear(
	eScanCode uScanCode) BURGER_NOEXCEPT
{
	uint_t bResult = FALSE;
	if ((uScanCode != SC_INVALID) &&
		(static_cast<uint_t>(uScanCode) <
			static_cast<uint_t>(SC_MAXENTRY + 1))) {
		const uint_t uTemp = m_KeyArray[uScanCode];
...
/*! ************************************
	...
	If the key is currently held down, return \ref TRUE, otherwise or if the
	scan code is invalid, return \ref FALSE
...
uint_t BURGER_API Burger::Keyboard::IsPressed(
	eScanCode uScanCode) const BURGER_NOEXCEPT
{
	uint_t bResult = FALSE;
	if ((uScanCode != SC_INVALID) &&
...
/*! ************************************
	...
	Check if a key is pending and return zero if not, else return the Unicode
	value. All key up events up until the key down are consumed.
...
/*! ************************************
	...
	Check if a key is pending and return zero if not, else the Unicode code in
	lower case
...
uint_t BURGER_API Burger::Keyboard::PostKeyDown(
	eScanCode uScanCode) BURGER_NOEXCEPT
{
	KeyEvent_t NewEvent;
...
uint_t BURGER_API Burger::Keyboard::PostKeyUp(
	eScanCode uScanCode) BURGER_NOEXCEPT
{
	KeyEvent_t NewEvent;
	uint_t bResult = EncodeScanCode(&NewEvent, uScanCode);
...
uint_t BURGER_API Burger::Keyboard::PostUnicodeDown(
	uint32_t uUnicode) BURGER_NOEXCEPT
{
	KeyEvent_t NewEvent;
...
uint_t BURGER_API Burger::Keyboard::PostUnicodeUp(
	uint32_t uUnicode) BURGER_NOEXCEPT
{
	KeyEvent_t NewEvent;
	uint_t bResult = EncodeUnicode(&NewEvent, uUnicode);
...
uint_t BURGER_API Burger::Keyboard::PostUnicode(
	uint32_t uUnicode) BURGER_NOEXCEPT
{
	KeyEvent_t NewEvent;
	uint_t bResult = EncodeUnicode(&NewEvent, uUnicode);
...
uint_t BURGER_API Burger::Keyboard::PostKeyEvent(
	const KeyEvent_t* pEvent) BURGER_NOEXCEPT
{
	Lock();
	...
	const uint_t uTemp = (uEnd + 1) & (kBufferSize - 1);
	if (uTemp != m_uArrayStart) {
		...
		const uint32_t uFlags = pEvent->m_uFlags;
		...
		if ((uScanCode != SC_INVALID) &&
			...
			if ((pEvent->m_uEvent == EVENT_KEYDOWN) ||
				(pEvent->m_uEvent == EVENT_KEYAUTO)) {

				uint8_t uKey = m_KeyArray[uScanCode];
				uKey = static_cast<uint8_t>(
					(uKey | (KEYCAPDOWN | KEYCAPPRESSED)) ^ KEYCAPTOGGLE);
...
/*! ************************************
	...
	Given a scan code, check the state of the keyboard and determine the
	Unicode/ASCII code to be generated for this keypress.

	\return Zero if successful, non-zero if a scan code is unknown.

***************************************/

uint_t BURGER_API Burger::Keyboard::EncodeScanCode(
	KeyEvent_t* pEvent, eScanCode uScanCode) const BURGER_NOEXCEPT
{
	// Look up the scan code
	uint_t uResult = 10;
	if ((uScanCode != SC_INVALID) &&
		(static_cast<uintptr_t>(uScanCode) <
			BURGER_ARRAYSIZE(g_ScanCodeTranslation))) {
		// Initialize the time stamp
		pEvent->m_uMSTimeStamp = 0;
		pEvent->m_uScanCode = static_cast<uint32_t>(uScanCode);

		// Determine the flags for the key
		const uint_t uFlags = GetCurrentFlags();
		pEvent->m_uFlags = static_cast<uint32_t>(uFlags);

		// Which translation entry to use?
		const ScanCodeToAscii_t* pTranslation =
			&g_ScanCodeTranslation[uScanCode];
...
/*! ************************************
	...
	Given a Unicode character, look up the scan code, if available, and fill in
	a KeyEvent_t to be generated for this keypress.

	\return Zero if successful, non-zero if the Unicode value is unknown.

***************************************/

uint_t BURGER_API Burger::Keyboard::EncodeUnicode(
...
/*! ************************************
	...
	\brief Return the flags for a KeyEvent_t based on the currently active
		modifiers

	Check the state of previously pressed keys and return the modifier flags for
	converting a scan code into an ASCII/Unicode value.
...
{
	uint_t uFlags = 0;
	if ((m_KeyArray[SC_LEFTALT] & KEYCAPDOWN) ||
		(m_KeyArray[SC_RIGHTALT] & KEYCAPDOWN)) {
		uFlags |= FLAG_ALT;
	}
	if ((m_KeyArray[SC_LEFTCONTROL] & KEYCAPDOWN) ||
		(m_KeyArray[SC_RIGHTCONTROL] & KEYCAPDOWN)) {
		uFlags |= FLAG_CONTROL;
	}
	if ((m_KeyArray[SC_LEFTSHIFT] & KEYCAPDOWN) ||
		(m_KeyArray[SC_RIGHTSHIFT] & KEYCAPDOWN)) {
		uFlags |= FLAG_SHIFT;
	}
	if ((m_KeyArray[SC_LEFTOPTION] & KEYCAPDOWN) ||
		(m_KeyArray[SC_RIGHTOPTION] & KEYCAPDOWN)) {
		uFlags |= FLAG_OPTION;
	}
...
/*! ************************************
	...
	Given a pointer to a string describing a keyboard scan code. Look up the
	scan code and return the value. I return a -1 if there is no match.
...
Burger::Keyboard::eScanCode BURGER_API Burger::Keyboard::StringToScanCode(
...
/*! ************************************
	...
	Given a Burgerlib keyboard scan code, return a string that best describes
	the scan code. If StringSize is 0, nothing will be done since the output
	buffer is invalid.
...
void BURGER_API Burger::Keyboard::ScanCodeToString(
	char* pString, uintptr_t uStringSize, eScanCode uScanCode) BURGER_NOEXCEPT
{
	if (uStringSize) {
