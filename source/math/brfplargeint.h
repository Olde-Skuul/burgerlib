...
public:
    ...
    static const uint_t kBitsPerElement = static_cast<uint_t>(sizeof(ChunkSize_t)) * 8;
    /** Number of bits in the table to handle double precision */
    static const uint_t kTotalBitsInTable = 1024 + 64;
    /** Number of elements in the data table */
    static const uint_t kMaxElements = kTotalBitsInTable / kBitsPerElement;
