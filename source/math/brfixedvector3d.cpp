...
{
	FloatToIntNearest(reinterpret_cast<Int32*>(&x),pInput->x);
	FloatToIntNearest(reinterpret_cast<Int32*>(&y),pInput->y);
	FloatToIntNearest(reinterpret_cast<Int32*>(&z),pInput->z);
}
