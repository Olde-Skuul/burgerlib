...
/* BEGIN */
namespace Burger {
extern const Word32ToFloat *g_pMP3CosinePoints[5];
extern const Word32ToFloat g_MP3FHTCosines[4][2];
extern const Word32ToFloat g_MP3DCT36Constants[18];
extern const Word32ToFloat g_MP3DCT12Constants[3];
