...
Burger::OSCursorImage::OSCursorImage() BURGER_NOEXCEPT:
...
Burger::eError BURGER_API Burger::OSCursorImage::CreateMonoChromeImage(
    const uint8_t* /*pXor */, const uint8_t* /* pAnd */, uint_t uWidth,
    uint_t uHeight, int_t iHotX, int_t iHotY) BURGER_NOEXCEPT
{
    m_uWidth = uWidth;
    m_uHeight = uHeight;
    m_iHotX = iHotX;
...
void BURGER_API Burger::OSCursor::SetImageFromIDNumber(eCursor eCursorNumber) BURGER_NOEXCEPT
{
...
void BURGER_API Burger::OSCursor::SetImage(const OSCursorImage* pImage) BURGER_NOEXCEPT
{
