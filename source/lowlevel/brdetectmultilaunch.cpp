...
/*! ************************************
	...
	to be running systemwide. This class will create a global object that's
	visible systemwide and if this object is in existence when this class is
	queried, then it means that this class is running multiple times. If the
	function is_multi_launched() returns \ref TRUE, then immediately exit the
	application since another is running elsewhere in the same system
