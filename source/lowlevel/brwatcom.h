...
#pragma intrinsic(fabs,sqrt,sin,cos)
}
...
#pragma aux _bswap = "bswap eax" parm [eax] value [eax] modify exact [eax];
...
#pragma aux BurgerIntMathMul32GetUpper32 = "imul edx" parm [eax] [edx] value [edx] modify exact [eax edx];
...
#pragma aux BurgerFixedMathMultiply = "imul edx" "shrd eax,edx,16" parm [eax] [edx] value [eax] modify exact [eax edx];

extern Fixed32 BurgerFixedMathDivide(Fixed32 fInputNumerator,Fixed32 fInputDenominator);
#pragma aux BurgerFixedMathDivide = "mov edx,eax" "shl eax,16" "sar edx,16" "idiv ebx" parm [eax] [ebx] value [eax] modify exact [eax edx];

extern Fixed32 BurgerFixedMathReciprocal(Fixed32 fInput);
#pragma aux BurgerFixedMathReciprocal = "cmp ecx,-1" "mov eax,080000000H" "je Done" "dec eax" "cmp ecx,2" "jb Done" "xor eax,eax" "mov edx,1" "idiv ecx" "Done:" parm [ecx] value [eax] modify exact [eax edx];

extern Int32 BurgerIntMathFromFloatFloor(float fInput);
#pragma aux BurgerIntMathFromFloatFloor = "sub esp,4" "fadd dword ptr [g_fBurgerIntMathNearesttable]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];

extern Int32 BurgerIntMathFromFloat(float fInput);
#pragma aux BurgerIntMathFromFloat = "sub esp,4" "fst dword ptr [esp]" "mov eax,[esp]" "shr eax,31" "fadd dword ptr [g_fBurgerIntMathNearesttable+eax*4]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];

extern Int32 BurgerIntMathFromFloatCeil(float fInput);
#pragma aux BurgerIntMathFromFloatCeil = "sub esp,4" "fadd dword ptr [g_fBurgerIntMathNearesttable+4]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];

extern Int32 BurgerIntMathFromFloatNearest(float fInput);
#pragma aux BurgerIntMathFromFloatNearest = "sub esp,4" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax];
...
#pragma aux BurgerFixedMathFromFloatFloor = "sub esp,4" "fmul dword ptr [g_fBurgerMath65536]" "fadd dword ptr [g_fBurgerIntMathNearesttable]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];

extern Fixed32 BurgerFixedMathFromFloat(float fInput);
#pragma aux BurgerFixedMathFromFloat = "sub esp,4" "fst dword ptr [esp]" "fmul dword ptr [g_fBurgerMath65536]""mov eax,[esp]" "shr eax,31" "fadd dword ptr [g_fBurgerIntMathNearesttable+eax*4]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];

extern Fixed32 BurgerFixedMathFromFloatCeil(float fInput);
#pragma aux BurgerFixedMathFromFloatCeil = "sub esp,4" "fmul dword ptr [g_fBurgerMath65536]" "fadd dword ptr [g_fBurgerIntMathNearesttable+4]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];

extern Fixed32 BurgerFixedMathFromFloatNearest(float fInput);
#pragma aux BurgerFixedMathFromFloatNearest = "sub esp,4" "fmul dword ptr [g_fBurgerMath65536]" "fistp dword ptr [esp]" "pop eax" parm [8087] value [eax] modify exact [eax];
