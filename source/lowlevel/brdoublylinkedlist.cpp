...
/*! ************************************
	...
	\fn const DoublyLinkedList * Burger::DoublyLinkedList::GetPrevious(
		void) const
...
/*! ************************************
	...
	Allocate memory using Burger::Alloc() and initialize a DoublyLinkedList with
	it.
...
Burger::DoublyLinkedList* BURGER_API Burger::DoublyLinkedList::New(
	void) BURGER_NOEXCEPT
{
	// Manually allocate the memory
	return new (Alloc(sizeof(DoublyLinkedList))) DoublyLinkedList();
}
