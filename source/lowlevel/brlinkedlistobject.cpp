...
/*! ************************************
	...
	The linked list manager works this way. A LinkedListObjects is the
	root entry. It contains all the	entries of the list and all calls use this
	root entry as a starting point.

	The LinkedListObjects::Object are where the magic happens.
	It is a member of a circular doubly linked list. The root
	LinkedListObjects structure is where you can find the beginning and
	the ending of the entire list quickly.

	Each LinkedListObjects::Object also has a pointer to the generic
	data that is contained and also a pointer to a function to discard the data
	once the entry itself is deleted. The function pointer could be \ref nullptr
	meaning that the data can be deleted with a simple call to Burger::Free().
	The data could also be pointing to the end of the base
	LinkedListObjects::Object structure if the
	LinkedListObjects::Object structure is part of a larger structure.
...
/*! ************************************
	...
	The function returns \ref CONTINUE to continue iteration, \ref ABORT to stop
	iteration and \ref DELETEOBJECT to tell the iterator to call the disposal
	function at a safe time. \ref ABORT and \ref DELETEOBJECT can be or'd
	together to perform both actions.
...
/*! ************************************
	...
	\sa ProcDataDelete, ProcFreeObjectAndData(Object *),ProcFreeData(Object *)
		or ProcFreeObject(Object *)

***************************************/

void BURGER_API Burger::LinkedListObjects::Object::ProcNull(
...
/*! ************************************
	...
	\sa ProcDataDelete, ProcNull(Object *),ProcFreeData(Object *) or
		ProcFreeObject(Object *)

***************************************/

void BURGER_API Burger::LinkedListObjects::Object::ProcFreeObjectAndData(
	Object* pObject) BURGER_NOEXCEPT
{
...
/*! ************************************
	...
	\sa ProcDataDelete, ProcNull(Object *),ProcFreeObjectAndData(Object *) or
		ProcFreeObject(Object *)

***************************************/

void BURGER_API Burger::LinkedListObjects::Object::ProcFreeData(
	Object* pObject) BURGER_NOEXCEPT
{
	Free(pObject->m_pData);
...
void BURGER_API Burger::LinkedListObjects::Object::ProcFreeObject(
	Object* pObject) BURGER_NOEXCEPT
{
	Free(pObject);
}
...
/*! ************************************
	...
	of a destructor, only use the functions ProcFreeData() or ProcNull().
...
void Burger::LinkedListObjects::Object::Destroy(void) BURGER_NOEXCEPT
{
	Detach();
...
/*! ************************************
	...
	the disposal functions ProcFreeObject() or ProcFreeObjectAndData() to
	release it

	\param pData Pointer to the data this object will control, \ref nullptr is
		acceptable
	\param pProc Pointer to the disposal function \return \ref nullptr if out of
		memory
...
/*! ************************************
	...
	\fn Burger::LinkedListObjects::Object * \
		Burger::LinkedListObjects::Object::GetNext(void) const
...
/*! ************************************
	...
	\fn Burger::LinkedListObjects::Object * \
		Burger::LinkedListObjects::Object::GetPrevious(void) const
...
/*! ************************************
	...
	\fn Burger::LinkedListObjects::Object::ProcDataDelete \
		Burger::LinkedListObjects::Object::GetDataDeleteProc(void) const
...
/*! ************************************
	...
	\fn void Burger::LinkedListObjects::Object::SetDataDeleteProc(
...
void Burger::LinkedListObjects::Destroy(void) BURGER_NOEXCEPT
{
...
/*! ************************************
	...
	\fn Burger::LinkedListObjects::Object *Burger::LinkedListObjects::GetFirst(
		void) const
...
Burger::LinkedListObjects::Object* Burger::LinkedListObjects::GetLast(
...
void* Burger::LinkedListObjects::GetFirstData(void) const BURGER_NOEXCEPT
{
	// Get the root pointer
	Object* pRoot = m_pRoot;
	void* pResult = nullptr;        // Assume no data
...
void* Burger::LinkedListObjects::GetLastData(void) const BURGER_NOEXCEPT
{
	// Get the root pointer
	Object* pRoot = m_pRoot;
	void* pResult = nullptr;          // Assume no data
	if (pRoot) {                      // Valid pointer?
		pRoot = pRoot->GetPrevious(); // Go to the last entry (Could be itself
									  // if only one entry)
		pResult = pRoot->GetData();   // Obtain the data pointer
	}
	// Return with the data or nullptr
...
void* Burger::LinkedListObjects::GetData(uint_t uIndex) const BURGER_NOEXCEPT
{
...
Burger::LinkedListObjects::Object* Burger::LinkedListObjects::GetObject(
	uint_t uIndex) const BURGER_NOEXCEPT
{
	...
	if (pResult) {             // Should I traverse?
		...
		do {
			if (!StringCaseCompare(
					static_cast<const char*>(pObject->GetData()), pString)) {
				pResult = pObject;
				break;
			}
			pObject = pObject->GetNext(); // Follow the list
...
/*! ************************************
	...
	Returns -1 if the string is not in the list. The comparison is case
	insensitive
...
uint_t Burger::LinkedListObjects::GetStringIndex(
	const char* pString) const BURGER_NOEXCEPT
{
...
void Burger::LinkedListObjects::DestroyObject(Object* pObject) BURGER_NOEXCEPT
{
	if (pObject) {
...
void Burger::LinkedListObjects::AppendObject(Object* pObject) BURGER_NOEXCEPT
{
	Object* pRoot = m_pRoot;
	if (!pRoot) {
		// It's the only entry
...
void Burger::LinkedListObjects::PrependObject(Object* pObject) BURGER_NOEXCEPT
{
	Object* pRoot = m_pRoot;
	if (!pRoot) {
		// It's the only entry
...
/*! ************************************
	...
	Allocate a new Object entry and attach this data pointer to it. The default
	data deletion procedure

	If there are no entries in the list, return \ref nullptr. Otherwise, return
	the data pointer of the last item in the linked list.
...
void Burger::LinkedListObjects::AppendObject(
...
void Burger::LinkedListObjects::PrependObject(
	void* pData, Object::ProcDataDelete pDataDelete) BURGER_NOEXCEPT
{
	// Create the new object
	Object* pObject = Object::New(pData, pDataDelete);
...
/*! ************************************
	...
	\return \ref nullptr if the list iterated to the end, or an Object pointer
		when \ref ABORT was returned

	\sa ProcAction or IterateReverse()

***************************************/

Burger::LinkedListObjects::Object* Burger::LinkedListObjects::IterateForward(
	...
	if (pFirst) {
		...
		do {
			const uint_t uResult =
				pProc(pObject->GetData());      // Call the function
...
Burger::LinkedListObjects::Object* Burger::LinkedListObjects::IterateReverse(
	ProcAction pProc) BURGER_NOEXCEPT
{
	Object* pFirst = m_pRoot; // Is there a list?
	if (pFirst) {
