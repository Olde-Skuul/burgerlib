...
uintptr_t BURGER_API Burger::SDBMHash(const void* pInput, uintptr_t uInputCount,
	uint32_t uHashSeed) BURGER_NOEXCEPT
{
	if (uInputCount) {
		do {
...
uintptr_t BURGER_API Burger::SDBMHashCase(const void* pInput,
