...
/*! ************************************
	...
	\sa DJB2HashAddCase(const void *,uintptr_t,uint32_t) or DJB2HashXor(const
		void *,uintptr_t,uint32_t)

***************************************/

uintptr_t BURGER_API Burger::DJB2HashAdd(const void* pInput,
...
/*! ************************************
	...
	\param uHashSeed Value to seed the hash with.
	\return 32 bit hash value generated by the data.
	\sa DJB2HashAdd(const void *,uintptr_t,uint32_t) or DJB2HashXorCase(const
		void *,uintptr_t,uint32_t)

***************************************/

uintptr_t BURGER_API Burger::DJB2HashAddCase(const void* pInput,
	uintptr_t uInputCount, uint32_t uHashSeed) BURGER_NOEXCEPT
{
	if (uInputCount) {
		do {
...
/*! ************************************
	...
	\param uHashSeed Value to seed the hash with.
	\return 32 bit hash value generated by the data.
	\sa DJB2HashXorCase(const void *,uintptr_t,uint32_t) or DJB2HashAdd(const
		void *,uintptr_t,uint32_t)

***************************************/

uintptr_t BURGER_API Burger::DJB2HashXor(const void* pInput,
	uintptr_t uInputCount, uint32_t uHashSeed) BURGER_NOEXCEPT
{
	if (uInputCount) {
		do {
...
/*! ************************************
	...
	\param uHashSeed Value to seed the hash with.
	\return 32 bit hash value generated by the data.
	\sa DJB2HashXor(const void *,uintptr_t,uint32_t) or DJB2HashAddCase(const
		void *,uintptr_t,uint32_t)

***************************************/

uintptr_t BURGER_API Burger::DJB2HashXorCase(const void* pInput,
	uintptr_t uInputCount, uint32_t uHashSeed) BURGER_NOEXCEPT
{
	if (uInputCount) {
		do {
