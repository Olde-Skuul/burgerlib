...
public:
	...
	static const uint32_t FILETYPE = 0x41504620;		///< 'APF ' Mac File type for APF files (Byte swapped on little endian machines)
	static const uint32_t AUXTYPE = 0x6F676C65;		///< 'ogle' Mac creator code for APF files (Byte swapped on little endian machines)
#else
	static const uint32_t FILETYPE = 0x20465041;		///< 'APF '
