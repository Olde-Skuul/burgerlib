...
public:
	...
	public:
		Generic(eType uType);
		virtual ~Generic();
		BURGER_INLINE Generic *GetNext(void) const { return static_cast<Generic *>(m_Link.get_next()->get_data()); }
	...
	public:
		...
		BURGER_INLINE void SetName(const char *pInput) { m_SectionName.assign(pInput); }
