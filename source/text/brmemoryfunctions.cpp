...
/*! ************************************
    ...
    \sa Burger::MemoryCharacter(const uint16_t *,uintptr_t,uint_t)
...
/*! ************************************
    ...
    \sa Burger::MemoryCharacter(const char *,uintptr_t,int)
...
/*! ************************************
    ...
    \sa Burger::MemoryCharacterReverse(const uint16_t *,uintptr_t,uint_t) and
...
/*! ************************************
    ...
    \sa Burger::MemoryCharacterReverse(const char *,uintptr_t,int) and
