...
/*! ************************************
	...
	\brief Initialize a Burger::String16 by using a subsection of a different
Burger::String16
...
Burger::String16::String16(
	const Burger::String16& rInput, uintptr_t uStart, uintptr_t uEnd)
{
	uintptr_t uInputLength = rInput.m_uLength; // Get the source length
...
/*! ************************************
	...
	Initialize the Burger::String16 with a copy of the passed string. The
...
Burger::String16::String16(const char* pInput) BURGER_NOEXCEPT
{
	...
	uintptr_t uInputLength = UTF16::translate_from_UTF8(nullptr, 0, pInput);
	uint16_t* pWork = m_Raw;
	if (uInputLength >= BUFFERSIZE) { // Buffer big enough?
		pWork = static_cast<uint16_t*>(
...
Burger::String16::String16(const char* pInput, uintptr_t uPadding)
{
	...
	uintptr_t uInputLength = UTF16::translate_from_UTF8(NULL, 0, pInput);
	uint16_t* pWork = m_Raw;
...
/*! ************************************
	...
	Helper to access the first character of the UTF16 "C" string. It can be
zero.
...
string. \return Zero if no error, non zero if memory allocation failed
...
Burger::eError BURGER_API Burger::String16::SetBufferSize(
...
/*! ************************************
	...
	\param pInput Pointer to a UTF8 "C" string. \ref NULL generates an empty
string. \return A reference to the this pointer
...
string \return A class instance of Burger::String16 containing the new string.
