...
/*! ************************************
	...
	\param cInput Single char to turn into a 1 character length string. Zero
will create an empty string. \sa Burger::SimpleString::SimpleString(const char
*)
...
/*! ************************************
	...
	\param pInput1 Pointer to input string. \ref NULL or an empty string is
acceptable. \sa Burger::SimpleString::SimpleString(const char *,const char *)
...
/*! ************************************
	...
	\param pInput1 Pointer to the first input string. \ref NULL or an empty
string is acceptable. \param pInput2 Pointer to the second input string. \ref
NULL or an empty string is acceptable. \sa
...
/*! ************************************
	...
	\param pInput1 Pointer to the first input string. \ref NULL or an empty
string is acceptable. \param pInput2 Pointer to the second input string. \ref
NULL or an empty string is acceptable. \param pInput3 Pointer to the third input
string. \ref NULL or an empty string is acceptable. \sa
Burger::SimpleString::SimpleString(const char *)

***************************************/

Burger::SimpleString::SimpleString(
	const char* pInput1, const char* pInput2, const char* pInput3)
{
	uintptr_t uLength1 = 0;
	if (pInput1) {
		uLength1 = StringLength(pInput1);
...
string is acceptable. \param pInput2 Pointer to the second input string. \ref
NULL or an empty string is acceptable. \param pInput3 Pointer to the third input
string. \ref NULL or an empty string is acceptable. \param pInput4 Pointer to
the fourth input string. \ref NULL or an empty string is acceptable. \sa
Burger::SimpleString::SimpleString(const char *)

***************************************/

Burger::SimpleString::SimpleString(const char* pInput1, const char* pInput2,
	const char* pInput3, const char* pInput4)
{
	uintptr_t uLength1 = 0;
	if (pInput1) {
		uLength1 = StringLength(pInput1);
...
NULL or an empty string is acceptable. \param pInput3 Pointer to the third input
string. \ref NULL or an empty string is acceptable. \param pInput4 Pointer to
the fourth input string. \ref NULL or an empty string is acceptable. \param
pInput5 Pointer to the fifth input string. \ref NULL or an empty string is
acceptable. \sa Burger::SimpleString::SimpleString(const char *)

***************************************/

Burger::SimpleString::SimpleString(const char* pInput1, const char* pInput2,
	const char* pInput3, const char* pInput4, const char* pInput5)
{
	uintptr_t uLength1 = 0;
	if (pInput1) {
		uLength1 = StringLength(pInput1);
...
Burger::SimpleString& Burger::SimpleString::operator=(
	const Burger::SimpleString& rInput)
{
	if (this != &rInput) {
		// Delete the previous string
		const char* pData = m_pData;
