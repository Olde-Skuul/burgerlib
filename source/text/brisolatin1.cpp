...
/*! ************************************
	...
	The character map for ISOLatin1 <a href="isolatin1.htm">looks like this.
	Click here.</a>
...
Word BURGER_API Burger::ISOLatin1::FromUTF8(
	char* pOutput, WordPtr uOutputSize, const char* pInput)
{
	...
	if (First) { // Can I start the loop?
		do {
			...
			} else if (First >= 0xC2U) { // Valid multi byte opcode?
