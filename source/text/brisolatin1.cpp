...
/*! ************************************
	...
	\note This is the filename charset for the Xbox 360

	\sa Win437, Win1252, or MacRomanUS
...
BURGER_ALIGN(const uint8_t, Burger::ISOLatin1::UpperCaseTable[256], 16) = {
	...
	0xD8, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE, 0xFF  // 0xF8
};
...
/*! ************************************
	...
	cannot be mapped to ISOLatin1 encoding, Burger::ISOLatin1::kInvalid will be
	returned instead.
	...
	\return The unsigned 8 bit character code (0x00-0xFF) or
		Burger::ISOLatin1::kInvalid if the UTF8 value wasn't low ASCII and
...
uint_t BURGER_API Burger::ISOLatin1::TranslateFromUTF8(
...
uint_t BURGER_API Burger::ISOLatin1::TranslateFromUTF8(char* pOutput,
