...
/*! ************************************
	...
	The character map for MacRomanUS <a href="macromanus.htm">looks like this.
	Click here.</a>
...
/*! ************************************
	...
	buffer size. The output pointer and size can be \ref NULL to have this
	...
	\param pOutput Pointer to byte buffer to receive the MacRomanUS encoded
		string. \ref NULL is okay if uOutputSize is zero, otherwise it will page
		fault.
...
Word BURGER_API Burger::MacRomanUS::FromUTF8(
...
/*! ************************************
	...
	\param pOutput Pointer to a byte buffer to receive the MacRomanUS string.
		\ref NULL is okay if uOutputSize is zero, otherwise a page fault will
		occur.
