...
/*! ************************************
	...
	\var const uint8_t Burger::MacRomanUS::g_UpperCase[256]
...
BURGER_ALIGN(const uint8_t, Burger::MacRomanUS::g_UpperCase[256], 16) = {
...
/*! ************************************
	...
	\var const uint8_t Burger::MacRomanUS::g_LowerCase[256]
...
BURGER_ALIGN(const uint8_t, Burger::MacRomanUS::g_LowerCase[256], 16) = {
	0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, // 0x00
	0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, // 0x08
	0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, // 0x10
	0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F, // 0x18
...
/*! ************************************
	...
	\var const uint8_t Burger::MacRomanUS::g_ToUTF8[128][4]
...
BURGER_ALIGN(const uint8_t, Burger::MacRomanUS::g_ToUTF8[128][4], 16) = {
...
/*! ************************************
	...
	\var const uint16_t Burger::MacRomanUS::g_ToUTF16[128]
...
BURGER_ALIGN(const uint16_t, Burger::MacRomanUS::g_ToUTF16[128], 16) = {
	0x00C4, // 0x80
	0x00C5, // 0x81
	0x00C7, // 0x82
	0x00C9, // 0x83
...
/*! ************************************
	...
	cannot be mapped to MacRomanUS encoding, CodePage::kInvalid will be returned
	instead.
	...
	\return The unsigned 8 bit character code (0x00-0xFF) or CodePage::kInvalid
		if the UTF8 value wasn't low ASCII and couldn't be mapped to MacRomanUS.
