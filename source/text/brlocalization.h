...
class Localization {
    ...
    BURGER_ENUM_CLASS_START(eLanguage, uint32_t) {
        /** Not declared */
        None,
            /** American English */
            English,
            ...
            SpanishDominicanRepublic =
                Spanish + 0x500,                 ///< Dominican Republic Spanish
            ...
            0x100, ///< Bokmål Norway (Official written language of Norway)
            NorwegianNynorsk =
                Norwegian + 0x200 ///< Nynorsk Norway (New Norwegian)
    }
    BURGER_ENUM_CLASS_END(eLanguage);
...
public:
    ...
    eError BURGER_API SetLanguage(eLanguage uLanguage);
};
