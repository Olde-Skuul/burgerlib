...
static const ScanCodeTranslation_t TranslationTable[] = {
	...
	{VK_DOWN, Burger::Keyboard::SC_DOWNARROW,
		Burger::Keyboard::ASCII_DOWNARROW},
	{VK_LEFT, Burger::Keyboard::SC_LEFTARROW,
		Burger::Keyboard::ASCII_LEFTARROW},
	{VK_RIGHT, Burger::Keyboard::SC_RIGHTARROW,
		Burger::Keyboard::ASCII_RIGHTARROW},
	...
	{VK_SCROLL, Burger::Keyboard::SC_SCROLLLOCK,
		Burger::Keyboard::ASCII_SCROLLLOCK},

	//	{VK_GRAVE,Burger::Keyboard::SC_GRAVE,'`','~'},
	//	{VK_MINUS,Burger::Keyboard::SC_MINUS,'-','_'},
	//	{VK_EQUALS,Burger::Keyboard::SC_EQUALS,'=','+'},
	{VK_BACK, Burger::Keyboard::SC_BACKSPACE,
		Burger::Keyboard::ASCII_BACKSPACE},
	...
	{VK_NUMPAD0, Burger::Keyboard::SC_KEYPAD0, Burger::Keyboard::ASCII_INSERT,
		'0'},
	{VK_NUMPAD1, Burger::Keyboard::SC_KEYPAD1, Burger::Keyboard::ASCII_END,
		'1'},
	{VK_NUMPAD2, Burger::Keyboard::SC_KEYPAD2,
		Burger::Keyboard::ASCII_DOWNARROW, '2'},
	{VK_NUMPAD3, Burger::Keyboard::SC_KEYPAD3, Burger::Keyboard::ASCII_PAGEDOWN,
		'3'},
	{VK_NUMPAD4, Burger::Keyboard::SC_KEYPAD4,
		Burger::Keyboard::ASCII_LEFTARROW, '4'},
	{VK_NUMPAD5, Burger::Keyboard::SC_KEYPAD5, '5', '5'},
	{VK_NUMPAD6, Burger::Keyboard::SC_KEYPAD6,
		Burger::Keyboard::ASCII_RIGHTARROW, '6'},
	{VK_NUMPAD7, Burger::Keyboard::SC_KEYPAD7, Burger::Keyboard::ASCII_HOME,
		'7'},
	{VK_NUMPAD8, Burger::Keyboard::SC_KEYPAD8, Burger::Keyboard::ASCII_UPARROW,
		'8'},
	{VK_NUMPAD9, Burger::Keyboard::SC_KEYPAD9, Burger::Keyboard::ASCII_PAGEUP,
		'9'},
	...
	{VK_STOP, Burger::Keyboard::SC_STOP}, {VK_OEM_AX, Burger::Keyboard::SC_AX},
	...
	{VK_ORANGEMODIFIER,
		static_cast<Burger::Keyboard::eScanCode>(
			Burger::Keyboard::SC_EXTRA + 1)}};
...
Burger::RunQueue::eReturnCode BURGER_API Burger::Keyboard::Poll(
	void* pData) BURGER_NOEXCEPT
{
	...
	// Note: Calling this function without the 2nd parameter set to
	// XINPUT_FLAG_KEYBOARD is a TCR #43 violation.

	while (XInputGetKeystroke(XUSER_INDEX_ANY, XINPUT_FLAG_KEYBOARD,
			   &KeyStroke) == ERROR_SUCCESS) {
		// Convert from Windows scan code to Burgerlib
		const ScanCodeTranslation_t* pTranslation =
			ScanCodeTranslate(KeyStroke.VirtualKey);
		if (pTranslation) {
			// Non-zero if it was a key down event
			uint_t uPressed =
				(KeyStroke.Flags &
					(XINPUT_KEYSTROKE_KEYDOWN | XINPUT_KEYSTROKE_REPEAT)) != 0;
			...
			if (uPressed) {
				...
				if (!uAscii) {
					...
					if (uAscii) {
						// Control key pressed?
						if ((pThis->m_KeyArray[SC_LEFTCONTROL] & KEYCAPDOWN) ||
							(pThis->m_KeyArray[SC_RIGHTCONTROL] & KEYCAPDOWN)) {
							uAscii = pTranslation->m_uControlCode;
							// Shift key pressed?
						} else if ((pThis->m_KeyArray[SC_LEFTSHIFT] &
									   KEYCAPDOWN) ||
							(pThis->m_KeyArray[SC_RIGHTSHIFT] & KEYCAPDOWN)) {
