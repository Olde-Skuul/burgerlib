...
uint_t BURGER_API Burger::Windows::TestVersion(void) BURGER_NOEXCEPT
{
    uint_t uResult = g_Globals.m_bVersionFlags; // Get the value
    ...
    if (!(uResult & VERSION_TESTED)) {
        ...
        if (GetVersionExW(&OSVersionInfo)) {
            ...
            if (OSVersionInfo.dwPlatformId == VER_PLATFORM_WIN32_WINDOWS) {
                ...
                // Cache the versions
                uint_t uMajor = OSVersionInfo.dwMajorVersion;
                uint_t uMinor = OSVersionInfo.dwMinorVersion;
        ...
        g_Globals.m_bVersionFlags = static_cast<uint8_t>(uResult);
    }
...
/*! ************************************
    ...
    \fn Burger::Windows::IsWin95orWin98(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsWinXPOrGreater(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsVistaOrGreater(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsWin7OrGreater(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsWin8OrGreater(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsWin10OrGreater(void)
...
HINSTANCE BURGER_API Burger::Windows::LoadLibraryIndex(eDLLIndex eIndex) BURGER_NOEXCEPT
{
    ...
    // Valid index?
    if (static_cast<uint_t>(eIndex) < DLL_COUNT) {
...
void* BURGER_API Burger::Windows::LoadFunctionIndex(eCallIndex eIndex) BURGER_NOEXCEPT
{
    ...
    // Valid index?
    if (static_cast<uint_t>(eIndex) < CALL_COUNT) {
...
/*! ************************************
    ...
    \fn Burger::Windows::IsDirectInputPresent(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsDirectInput8Present(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsXInputPresent(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsDirectDrawPresent(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsD3D9Present(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsDirectSoundPresent(void)
...
/*! ************************************
    ...
    \fn Burger::Windows::IsDirectPlayPresent(void)
...
uint_t BURGER_API Burger::Windows::IsXAudio2Present(void)
{
    // Start up CoInitialize() to allow creating instances
    const uint_t bCleanupCOM = (CoInitialize(nullptr) >= 0);

    IXAudio2* pXAudio2 = nullptr;
    const HRESULT hr = CoCreateInstance(CLSID_XAudio2, nullptr, CLSCTX_INPROC_SERVER,
